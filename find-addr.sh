...
export afl_path="$BASEPATH/AFLplusplus/AFLplusplus"
export corpus_path="$FUZZ_DIR/in"
export output_path="$FUZZ_DIR/out"
export target_path="$BASEPATH/example-tcp-server.o"
